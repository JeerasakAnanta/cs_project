  ...
  return (
    <div className="p-8 bg-neutral-900 min-h-screen">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8">Typing Animation Test</h1>
        ...
        <div className="space-y-6">
          ...
          {showAnimation && (
            <div className="bg-neutral-800 p-6 rounded-lg">
              <h2 className="text-xl font-semibold text-white mb-4">Animation Preview</h2>
          ...
          {/* All Variants */}
          <div className="bg-neutral-800 p-6 rounded-lg">
            <h2 className="text-xl font-semibold text-white mb-4">All Variants</h2>
            <div className="space-y-4">
              <div>
