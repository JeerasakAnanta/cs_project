  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-between text-xs">
              <span
                className={
                  theme === 'light' ? 'text-green-600' : 'text-green-200'
                }
              >
                Registered
              </span>
        ...
        >
          ...
          <div className="space-y-1">
            <div className="flex justify-between text-xs">
              ...
              <span
                className={
                  theme === 'light' ? 'text-purple-600' : 'text-purple-200'
                }
              >
                User
              </span>
        ...
        {/* Feedback Card */}
        <div
          className={`bg-gradient-to-br from-amber-600/20 to-amber-800/20 border border-amber-500/30 rounded-xl p-6 ${
            theme === 'light'
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-between text-xs">
              <span
                className={
                  theme === 'light' ? 'text-amber-600' : 'text-amber-200'
                }
              >
                Likes
              </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Role Distribution */}
        <div
          className={`bg-gradient-to-br from-slate-600/20 to-slate-800/20 border border-slate-500/30 rounded-xl p-6 ${
            theme === 'light'
          ...
          >
            <Users
              className={`w-5 h-5 mr-2 ${
                theme === 'light' ? 'text-slate-600' : 'text-primary-400'
              }`}
            />
            การกระจายของ Role
          </h4>
                  ...
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-24 rounded-full h-2 ${
                        theme === 'light' ? 'bg-slate-200' : 'bg-neutral-700'
                      }`}
                    >
                      <div
                        className={`h-2 rounded-full ${
                          theme === 'light' ? 'bg-slate-500' : 'bg-primary-500'
                        }`}
                        style={{
        ...
        {/* Recent Activity */}
        <div
          className={`bg-gradient-to-br from-lime-500/20 to-lime-200/20 border border-lime-200/30 rounded-xl p-6 ${
            theme === 'light'
        ...
        >
          ...
          >
            <Clock
              className={`w-5 h-5 mr-2 ${
                theme === 'light' ? 'text-lime-600' : 'text-green-400'
              }`}
            />
            กิจกรรมล่าสุด (7 วัน)
          </h4>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span
                className={
                  theme === 'light' ? 'text-lime-600' : 'text-lime-300'
                }
              >
                การสนทนาใหม่
              </span>
      ...
      <div
        className={`bg-sky-300/50 border border-sky-300/30 rounded-xl p-6 ${
          theme === 'light'
      ...
      >
        ...
        >
          <Calendar
            className={`w-5 h-5 mr-2 ${
              theme === 'light' ? 'text-sky-600' : 'text-amber-400'
            }`}
          />
            ...
            <div key={day.date} className="text-center">
              <div
                className={`text-xs mb-2 ${
                  theme === 'light' ? 'text-sky-600' : 'text-neutral-400'
                }`}
              >
              ...
              <div
                className={`rounded-lg p-2 ${
                  theme === 'light' ? 'bg-sky-100' : 'bg-neutral-700/50'
                }`}
              >
                <div
      ...
      {userStats.top_users_by_conversations.length > 0 && (
        <div
          className={`bg-green-300 border border-green-300 rounded-xl p-6 ${
            theme === 'light'
              ? 'bg-gradient-to-br from-green-50 to-green-100 border-green-200'
              : ''
          }`}
              ...
              .map((user, index) => (
                <div
                  ...
                  className={`flex items-center justify-between p-3 rounded-lg ${
                    theme === 'light' ? 'bg-green-100' : 'bg-neutral-700/30'
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <div
                  ...
                  <div className="text-right">
                    <div
                      className={`text-lg font-bold ${
                        theme === 'light' ? 'text-gray-900' : 'text-neutral-400'
                      }`}
                    >
      ...
      {/* System Status */}
      <div
        className={`bg-yellow-200 border border-yellow-200 rounded-xl p-6 ${
          theme === 'light'
