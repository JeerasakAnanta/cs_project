...
const DocumentSearchDashboard: React.FC<DocumentSearchDashboardProps> = ({
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const avgConfidence =
        documents.length > 0
          ? documents.reduce((sum, doc) => sum + doc.confidence_score, 0) /
            documents.length
          : 0;
  ...
  return (
    <div className={`${className}`}>
            ...
            >
              ...
              >
                {documents.length > 0
                  ? (
                      (documents.reduce(
                        (sum, doc) => sum + doc.confidence_score,
                        0
                      ) /
                        documents.length) *
                      100
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                const percentage =
                  documents.length > 0 ? (count / documents.length) * 100 : 0;
      ...
      {/* Document Results */}
      <EnhancedDocumentDisplay references={documents} query={query} />
